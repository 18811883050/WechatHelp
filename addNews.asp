...
<body style="overflow-x:hidden ; overflow-y:auto;">
                        ...
                        <div class="panel-heading">
                           图文列表选择
							...
							<form method="post" id="uploadForm" enctype="multipart/form-data" >
								...
								<input type="hidden" value="" name="allTitle" />
								<input type="hidden" value="" name="allLink" />
								<input type="hidden" value="" name="allmiaoshu" />
										...
										<div class="fileupload fileupload-new" data-provides="fileupload">
											...
											<div class="duan">
												...
												<div class="form-group miaoshu" >
														<label>图文描述</label>
														<textarea class="form-control" rows="3"  placeholder="多图文时描述可以不填写" ></textarea>
												</div>
	...
	$("#addMsg").click(function(){
				...
				if(miaoshu!="" || miaoshu!=undefined){
					 $("input[name=allmiaoshu]").val(miaoshu);
				}
